import com.workintech.Contact;
import com.workintech.GroceryList;
import com.workintech.MobilePhone;
...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            System.out.println("0: quit, 1: add item, 2: remove item");
            choice = scanner.nextInt();
            scanner.nextLine();
            switch (choice) {
                case 1:
                    System.out.println("Eklenmek istenen ürünleri giriniz");
